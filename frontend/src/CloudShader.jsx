...
// Cloud shader: each cloud is an asymmetric envelope (dome top, flat base)
// filled with domain-warped billow noise. A second density sample above the
// pixel approximates self-shadowing. Clouds drift horizontally and wrap around.
const FRAG = `
...
function compile(gl, type, source) {
  ...
  if (!gl.getShaderParameter(shader, gl.COMPILE_STATUS)) {
    console.warn('CloudShader compile error:', gl.getShaderInfoLog(shader));
